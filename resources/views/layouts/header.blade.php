                ...
                <div class="container-fluid">
                    <div class="header__row row justify-content-between">
                      ...
                      <svg class="icon-icon-arrow-down">
                        ...
                        <!--                                    <h4 class="dropdown-menu__item-title">John D</h4>-->
                        ...
                        <!--        </div>-->
                            ...
                            <div class="header__profile dropdown">
                                <a class="header__profile-toggle dropdown__toggle" href="#" data-toggle="dropdown">
                                    <div class="header__profile-text"><span>@if(!empty(Auth::user()->user_type)) {{ Auth::user()->user_type}} @endif&nbsp;&nbsp;&nbsp;</span>
                                    </div>
                      ...
                      <svg class="icon-icon-arrow-down">
                        <use xlink:href="#icon-arrow-down"></use>
                                ...
                                <div class="profile-dropdown dropdown-menu dropdown-menu--right"><a class="profile-dropdown__item dropdown-menu__item" href="{{url('/profile')}}" tabindex="0"><span class="profile-dropdown__icon">
