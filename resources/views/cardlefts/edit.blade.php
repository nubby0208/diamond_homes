...
@section('content')
    <div class="container container--flex">
                <div class="page-header">
                    <h1 class="page-header__title">Edit Card Left</h1>
                </div>
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Edit Card Left</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card add-product">
                    <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="post" action="{{route('cardlefts.update',$notes->id)}}" enctype="multipart/form-data">
                              {{ method_field('PATCH') }}
                                        ...
                                        <div class="row row--md">
                                            <div class="col-6 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="action" placeholder="" value="{{$notes->action}}" >
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-3 form-group form-group--lg">
                                                ...
                                                <div class="input-group input-group--append" >
                                                    <select class="input js-input-select input--fluid" name="assigned_to" data-placeholder="">
                                                        ...
                                                        <option value="{{$user->first_name}}" <?php if($notes->assigned_to == $user->first_name) { echo "selected"; } ?>>{{$user->title}} {{$user->first_name}} {{$user->last_name}} </option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                                    <span class="input-group__arrow">
                                             ...
                                             <div class="col-3 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="lattitude" placeholder="" value="{{$notes->lattitude}}" >
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-3 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="longitude" placeholder="" value="{{$notes->longitude}}" >
                                                </div>
                                            </div>
                                             <div class="col-3 form-group form-group--lg">
                                                <label class="form-label">Distance</label>
                                                <div class="input-group">
                                                    <input class="input" type="text" name="distance" placeholder="" value="{{$notes->distance}}" >
                                                </div>
                                            </div>
                                             <div class="col-3 form-group form-group--lg">
                                                <label class="form-label">Photo</label>
                                                <div class="input-group">
                                                    <input class="input" type="file" name="photo" placeholder="" value="" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 form-group form-group--lg">
                                                ...
                                                <textarea rows="10" class="form-control" name="reason">{{$notes->reason}}</textarea>
