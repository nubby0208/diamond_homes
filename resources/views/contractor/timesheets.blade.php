                                    ...
                                    <td class="table__td">
                                        <div class="media-item media-item--medium">
                                            ...
                                            <div class="media-item__right">
                                                <h5 class="media-item__title"><a href="#">{{ $row->title }} </a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="table__td text-light-theme">{{ $row->from_date }}</td>
                                    <td class="table__td text-dark-theme">{{ $row->to_date }}</td>
                                    <td class="table__td text-light-theme">{{ $row->created_at }}</td>
                                                ...
                                                <div class="dropdown-items__container">
                                                    <ul class="dropdown-items__list">
                                                        ...
                                                        <li class="dropdown-items__item">
                                                           ...
                                                           <form  class="dropdown-items__link" method="POST" action="#">
                                                                    @csrf 
