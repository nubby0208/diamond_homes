...
@section('content')
     <div style="padding: 0 30px;">
                <div class="page-header" >
                    <h2 class="page-header__title">All Contractor</h2>
                </div>
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">All Contractor</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                                ...
                                                <div class="dropdown-items__container">
                                                    <ul class="dropdown-items__list">
                                                        ...
                                                        <li class="dropdown-items__item">
                                                           ...
                                                           <form  class="dropdown-items__link" method="POST" action="{{ route('contractors.delete', $user->id) }}">
                                                                    @csrf 
