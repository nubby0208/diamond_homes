...
@section('content')
    <div class="container container--flex">
                <div class="page-header">
                    <h1 class="page-header__title">Add Tenant</h1>
                </div>
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Add Tenant</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card add-product">
                    <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="post" action="{{route('tenants.store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row row--md">
                                            <div class="col-8 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="to_from" placeholder="" value="" required>
                                                </div>
                                            </div>
