...
@section('content')
      <div class="container">
                                ...
                                <div class="widget__wrapper">
                                    <div class="widget__row">
                                        <div class="widget__left">
                                            <h3 class="widget__title">Total Qualifying<br>Jobs Invoiced</h3>
                                           
                                            <div class="widget__spacer"></div>
                                            <div class="widget__trade"><span class="trade-icon trade-icon--up">
                            <svg class="icon-icon-trade-up">
                              <use xlink:href="#icon-trade-up"></use>
                            </svg></span><span class="widget__trade-count" style="color:#09b66d;">$542</span>
                                            </div>
                                            <div>
                                                <img class="" src="img/content/may.png" alt="#">
                                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-6 d-flex">
                            <div class="widget">
                                <div class="widget__wrapper">
                                    <div class="widget__row">
                                        <div class="widget__left">
                                            <h3 class="widget__title">Total Qualifying<br>Jobs On App</h3>
                                            <div class="widget__spacer"></div>
                                            <div class="widget__trade"><span class="trade-icon trade-icon--up">
                            <svg class="icon-icon-trade-up">
                              <use xlink:href="#icon-trade-up"></use>
                ...
                <div class="widgets" style="margin-top: 2em;">
                    <div class="widgets__row row gutter-bottom-xl">
                        <div class="col-12 col-sm-6 col-xl-4 d-flex">
                            <div class="widget">
                                <div class="widget__wrapper">
                                    ...
                                    <div>
                                            <h2 style="text-align: center; font-size: 20px;margin-top: 2em;">Not Completed On App</h2>
                                            <img class="" src="img/content/may.png" alt="#" style="margin: auto; display: block;">
                                        </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-4 d-flex">
                            <div class="widget">
                                <div class="widget__wrapper">
                                    ...
                                    <div>
                                            <h2 style="text-align: center; font-size: 20px;margin-top: 2em;">Value Earned</h2>
                                            <img class="" src="img/content/may.png" alt="#" style="margin: auto; display: block;">
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-4 d-flex">
                            <div class="widget">
                                <div class="widget__wrapper">
                                    ...
                                    <div>
                                            <h2 style="text-align: center; font-size: 20px;margin-top: 2em;">Value Lost</h2>
                                            <img class="" src="img/content/may.png" alt="#" style="margin: auto; display: block;">
                                        </div>
                                </div>
                            </div>
                                                ...
                                                <div class="card__tools-row row row--xs gutter-bottom-xs">
                                                    <div class="card__tools-calendar col-auto">
                                                        <div class="input-group input-group--prepend input-group--append">
                                                            ...
                                                            <input class="input input--select js-datepicker" type="text" value="01.12.18 / 07.12.18" /><span class="input-group__arrow">
