...
@section('content')
    <div class="container container--flex">
                <div class="page-header">
                    <h1 class="page-header__title">Add Time spent</h1>
                </div>
                                    ...
                                    <li class="breadcrumbs__item disabled"><a class="breadcrumbs__link" href="#"><span>Dashbord</span>
                                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                          <use xlink:href="#icon-keyboard-right"></use>
                                                    ...
                                                    <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="#"><span>Time spent</span>
                                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                          <use xlink:href="#icon-keyboard-right"></use>
                                        </svg></a>
                                    </li>
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Add Time spent</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card add-product">
                    <div class="card__wrapper">
                        <div class="card__container">
                            <form class="add-product__form" method="post" action="{{route('timespents.store')}}" enctype="multipart/form-data">
                                 ...
                                 <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                    <div class="add-product__right">
                                        <div class="row row--md">
                                            <div class="col-5 form-group form-group--lg">
                                             ...
                                             <div class="col-3 form-group form-group--lg">
                                              ...
                                              <div class="col-2 form-group form-group--lg">
                                                ...
                                                <div class="input-group input-group--append" >
                                                    <select class="input js-input-select input--fluid" name="created_by" data-placeholder="">
                                                        <option value="0" selected>Select Created by </option>
                                                         @if(!empty($users))
                                            ...
                                            <div class="col-2 form-group form-group--lg">
                                                <label class="form-label">Card Left</label>
                                                <div class="input-group input-group--append" >
                                                    <select class="input js-input-select input--fluid" name="card_left" data-placeholder="">
                                                        <option value="On" selected="selected">Card Left On </option>
                                                        <option value="off">Card Left Off</option>
