...
@section('content')
     <div style="padding: 0 30px;">
                <div class="page-header" >
                    <h2 class="page-header__title"><?php echo $title; ?></h2>
                </div>
                <div  class="page-tools">
                    ...
                    <div class="page-tools__right">
                        <div class="page-tools__right-row">
                            <div class="page-tools__right-item"><a class="button-icon" href="{{url('tradies-directory/create')}}"><span class="button-icon__icon">
                ...
                <div class="table-wrapperdfd">
                       ...
                       <table id="example" class="table table--spaces" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach($tradies as $note)
                                <tr class="table__row">
                                    <td class="table__td">#{{$note->id}}</td>
                                    <td class="table__td">{{$note->tradie_name}}</td>
                                    <td class="table__td"><a href="tel:{{$note->phone}}">{{$note->phone}}</a></td>
                                            ...
                                            <div class="dropdown-items dropdown-items--right">
                                                <div class="dropdown-items__container">
                                                    <ul class="dropdown-items__list">
                                                        <li class="dropdown-items__item"><a class="dropdown-items__link" href="{{route('tradies-directory.edit',$note->id)}}"><span class="dropdown-items__link-icon">
                                                        ...
                                                        <li class="dropdown-items__item">
                                                           ...
                                                           <form  class="dropdown-items__link" method="POST" action="{{ route('tradies-directory.destroy', $note->id) }}">
                                                                 @csrf 
