...
@section('content')
     <div style="padding: 0 30px;">
                <div class="page-header" >
                    <h2 class="page-header__title">All Logs</h2>
                </div>
                <div  class="page-tools">
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item active"><span class="breadcrumbs__link">All Logs</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="page-tools__right">
                        <div class="page-tools__right-row">
                            <div class="page-tools__right-item"><a class="button-icon" href="{{url('logs/create')}}"><span class="button-icon__icon">
                                            ...
                                            <div class="dropdown-items dropdown-items--right">
                                                <div class="dropdown-items__container">
                                                    <ul class="dropdown-items__list">
                                                        <li class="dropdown-items__item"><a class="dropdown-items__link" href="{{route('logs.edit',$note->id)}}"><span class="dropdown-items__link-icon">
                                                        ...
                                                        <li class="dropdown-items__item">
                                                           ...
                                                           <form  class="dropdown-items__link" method="POST" action="{{ route('logs.destroy', $note->id) }}">
                                                                 @csrf 
